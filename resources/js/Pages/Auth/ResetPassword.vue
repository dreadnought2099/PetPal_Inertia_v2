<template>
    <AppLayout>
        <div
            class="min-h-screen flex flex-col justify-center items-center bg-gray-100 px-4"
        >
            <div class="w-full max-w-md bg-white p-6 rounded-lg shadow-md">
                ...
                <div
                    ...
                    class="bg-red-100 border border-red-400 text-red-700 p-3 rounded-md mb-4"
                >
                ...
                <div
                    v-if="status"
                    class="bg-green-100 border border-green-400 text-green-700 p-3 rounded-md mb-4"
                >
                    {{ status }}
                </div>
